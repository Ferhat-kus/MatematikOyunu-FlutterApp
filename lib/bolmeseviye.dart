...
class Bolmeseviye extends StatelessWidget {
  @override
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          ...
          centerTitle: true,
          title:
              const Text("Bölme Seviye", style: TextStyle(color: Colors.white)),
          leading: InkWell(
            onTap: () {
